...
(function () {
    ...
    function initTerminal() {
        ...
        var COMMANDS = {
            ...
            apps: function () {
                /*TERMAPPS_START*/
                print('Hasnain Studio X - 69 applications live, 1 in development', 'ok');
                print('', '');
                print('WINDOWS (64)', 'warn');
                print('  AI tools: DreamMint AI, HSX DocClarity, HSX DreamVivid AI, HSX FotoTensor, HSX InfiniteGen Studio, HSX Nostalgicel, HSX NovaDiffux, HSX Pocktium, HSX PromptKinetics, HSX QuantumGen AI Studio, HSX StudioFlow, HSX WriteDesk', '');
